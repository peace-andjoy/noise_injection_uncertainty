...
folders = ['cifar10_vanilla_resnet8_4_160_SGD_notadv', 'cifar10_noise_resnet8_4_160_SGD_notadv', 'cifar10_fixnoise_resnet8_4_160_SGD_notadv_0.05', 'cifar10_dropout_resnet8_4_160_SGD_notadv_dr0.1']
# folders = ['cifar10_noise_resnet8_4_160_SGD_notadv']
folders_label = ['vanilla', 'MCNI(learned)', 'MCNI(fixed)', 'MC dropout']

for img_id in img_ids:
    target = test_data[img_id][1]
    targets = list(set(img_id_to_dict[img_id]['cifar10_vanilla_resnet8_4_160_SGD_notadv'].values()))
    if len(targets)==1:
        continue
    print(img_id)
    ...
    for i, folder in enumerate(folders):
        ...
        for package in os.listdir(args.resume_path):
            ...
            for x, angle in enumerate(angles):
                ...
                softmax, lines = plot_softmaxs_ax(rotated_inputs, targets, net, x=x, ax=ax, test_times=10)
