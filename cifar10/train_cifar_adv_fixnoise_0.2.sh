...
tb_path=./save/${DATE}/${dataset}_${model}_${epochs}_${optimizer}_${label_info}_${fix_noise_level}/tb_log  

############### main function ############################
{
python main.py --dataset ${dataset} \
    --data_path ${data_path}   \
    --arch ${model} --save_path ./save/${DATE}/${dataset}_${model}_${epochs}_${optimizer}_${label_info}_${fix_noise_level} \
    --epochs ${epochs} --learning_rate 0.1 \
    --optimizer ${optimizer} \
	--schedule 80 120  --gammas 0.1 0.1 \
    --batch_size ${batch_size} --workers 4 --ngpu 1 --gpu_id 0 \
    --print_freq 100 --decay 0.0003 --momentum 0.9 \
    --fix_noise_level ${fix_noise_level} --adv_train
} &
############## Tensorboard logging ##########################
{
