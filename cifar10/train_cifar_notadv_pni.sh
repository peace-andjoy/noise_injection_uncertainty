...
tb_path=./save/${DATE}/${dataset}_${model}_${num_filters}_${epochs}_${optimizer}_${label_info}/tb_log  


# add more labels as additional info into the saving path
label_info=notadv_${weight_decay_alpha}

############### main function ############################
{
python main.py --dataset ${dataset} \
    --data_path ${data_path}   \
    --arch ${model} --save_path ./save/${DATE}/${dataset}_${model}_${num_filters}_${epochs}_${optimizer}_${label_info} \
    --epochs ${epochs} --learning_rate 0.1 \
    --optimizer ${optimizer} \
	--schedule 80 120  --gammas 0.1 0.1 \
    --batch_size ${batch_size} --workers 4 --ngpu 1 --gpu_id 0 \
    --print_freq 100 --decay 0.0003 --momentum 0.9 \
    --num_filters ${num_filters} --weight_decay_alpha ${weight_decay_alpha}
} &
############## Tensorboard logging ##########################
{
