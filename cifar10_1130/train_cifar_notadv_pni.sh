...
weight_decay_alpha=-0.02

#dataset path
data_path='/home/xueqiong/CVPR_2019_PNI-master/data'
#tensorboard log path
tb_path=./save/${DATE}/${dataset}_${model}_${num_filters}_${epochs}_${optimizer}_${label_info}_${weight_decay_alpha}/tb_log  
...
python main.py --dataset ${dataset} \
    --data_path ${data_path}   \
    --arch ${model} --save_path ./save/${DATE}/${dataset}_${model}_${num_filters}_${epochs}_${optimizer}_${label_info}_${weight_decay_alpha} \
